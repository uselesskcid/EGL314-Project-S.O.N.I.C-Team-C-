...
MA3_IP = "192.168.254.30"		# laptop IP
...
def REA_JumpWin(): #Marker 17
	send_message(REA_IP, REA_PORT, "/action/41257", REA_MSG)
	print('Marker 17 jumped')

def REA_JumpLose(): #Marker 10
	send_message(REA_IP, REA_PORT, "/action/40160", REA_MSG)
	print('Marker 10 jumped')	

def REA_JumpSampleBeat(): #Marker 42
	send_message(REA_IP, REA_PORT, "/marker/56", REA_MSG)
	print('Marker 42 jumped')	
