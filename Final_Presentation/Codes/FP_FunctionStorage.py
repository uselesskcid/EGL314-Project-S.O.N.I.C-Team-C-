...
# Latest Changes: Changed Sequence 95 with 107
...
def MA3_Seq99(): # Station Start
	send_message(MA3_IP, MA3_PORT, MA3_ADDR, "Off MyRunningSequence")
	send_message(MA3_IP, MA3_PORT, MA3_ADDR, "Go+: Sequence 99")
	print('Sequence 99 played')
...
def MA3_Seq107(): # Laser Sequence Preparation
	send_message(MA3_IP, MA3_PORT, MA3_ADDR, "Off MyRunningSequence")
	send_message(MA3_IP, MA3_PORT, MA3_ADDR, "Go+: Sequence 101")
	print('Sequence 102 played')
