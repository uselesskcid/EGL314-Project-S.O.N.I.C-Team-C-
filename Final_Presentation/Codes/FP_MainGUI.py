...
# Last edited 2nd August, 3pm
# Latest Changes: Renamed functions
...
ma3_99_btn = tk.Button(main, text="Station Start (99)", bg="GREEN", command=fs.MA3_Seq99,width=20,height=4)
...
ma3_107_btn = tk.Button(main, text="Laser Preparation (107)", bg="GREEN",command=fs.MA3_Seq107,width=20,height=4)
