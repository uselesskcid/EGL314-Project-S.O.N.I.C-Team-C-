...
L[Laptop GUI] <--LAN/WiFi + OSC--> M[Raspberry Pi - Laser Master]
M -WiFi---> N[Raspberry Pi - Laser Slave 1]
M --WiFi--> o[Raspberry Pi - Laser Slave 2]
M --WiFi--> P[Raspberry Pi - Laser Slave 3]
M --WiFi--> Q[Raspberry Pi - Laser Slave 4]
M --WiFi--> R[Raspberry Pi - Neopixel]